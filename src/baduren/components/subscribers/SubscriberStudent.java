    ...
    public void			execute() throws Exception
    {
        ...
        switch(this.number_student) {
            case 1:
                ...
                Thread.sleep(1000);
                unsubscribe("PC3R", this.receptionInboundPort.getPortURI());
                Thread.sleep(1000);
            ...
            case 2:
                ...
                Thread.sleep(5000);
                unsubscribe("PAF", this.receptionInboundPort.getPortURI());
                unsubscribe("PC3R", this.receptionInboundPort.getPortURI());
                unsubscribe("CPS", this.receptionInboundPort.getPortURI());
                break;
        }
